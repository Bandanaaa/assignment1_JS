...
function CalculateFutureAge(birth,future) {
    let diff=future-birth;
    return diff;
}

var Age= CalculateFutureAge(1998,2026);
var AlternateAge=Age+1;

console.log("You will be " +Age +" or "+AlternateAge+" in 2026")
